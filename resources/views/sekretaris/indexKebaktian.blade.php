        ...
        eventClick: function(info) {
            ...
            fetch('/sekretaris/jadwal/detail/' + id)
                ...
                .then(data => {
                    ...
                    document.getElementById('modalTanggal').innerText = data.tanggal_pelayanan;
                    ...
                    document.getElementById('btnEdit').href = '/sekretaris/jadwal/' + id + '/edit';

                    document.getElementById('deleteForm').action = '/sekretaris/jadwal/' + id;
